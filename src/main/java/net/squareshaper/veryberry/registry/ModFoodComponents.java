...
public class ModFoodComponents {
    ...
    public static final FoodComponent THORNBERRIES = new FoodComponent.Builder().nutrition(2).saturationModifier(0.25f)
            .statusEffect(new StatusEffectInstance(ModEffects.THORNY, 400, 0), 1f).alwaysEdible().build();
